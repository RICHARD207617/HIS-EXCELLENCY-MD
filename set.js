...
module.exports = { session: process.env.SESSION_ID || 'sessionid',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/RICHARD207617/HIS-EXCELLENCY-MD.git',
    OWNER_NAME : process.env.OWNER_NAME || "𝐇𝐈𝐒 𝐄𝐗𝐂𝐄𝐋𝐋𝐄𝐍𝐂𝐘",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "254140335101",
    DEV : process.env.DEV || "Janam is always right😎",
    ...
    GURL: process.env.GURL  || "https://whatsapp.com/channel/0029Vb9B3f5545umDDuj6E2L",
    CAPTION : process.env.CAPTION || "Janam is always right😎",
    BOT : process.env.BOT_NAME || 'Janam is always right😎',
